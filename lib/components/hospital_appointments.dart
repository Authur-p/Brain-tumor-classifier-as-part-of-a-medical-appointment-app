...
class HospitalAppointmentPage extends StatefulWidget {
  const HospitalAppointmentPage({super.key});

  @override
  State<HospitalAppointmentPage> createState() =>
      _HospitalAppointmentPageState();
}

//enum for appointment status
enum FilterStatus { upcoming, complete, cancel }

class _HospitalAppointmentPageState extends State<HospitalAppointmentPage> {
  ...
  Future<void> _getAppointments() async {
    try {
      ...
      final url = '$d_url/hospital/patient/appointments';
      final response =
      ...
      if (response.statusCode == 204) {
        ...
        showDialog(
          ...
          builder: (BuildContext context) => AlertDialog(
            ...
            content: const Text(
                "No appointments, come back later (when you have patients)."),
            actions: <Widget>[
              TextButton(
